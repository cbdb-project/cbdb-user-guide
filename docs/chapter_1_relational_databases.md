...
## A. Relational Database and the Organization of Complex Data {: #a-rel-db }
...
## B. Rules for Structuring Data in a Relational Database {: #b-structuring }
...
## C. Relational Databases and the Interactions of Complex Data {: #c-interactions }
